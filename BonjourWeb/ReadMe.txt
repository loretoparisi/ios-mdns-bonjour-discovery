...
This project was adapted by Apple's Bonjour Browser that was not compatibile with iOS>iOS8 anymore
@author: @loretoparisi ( https://github.com/loretoparisi/ )

https://github.com/loretoparisi/ios-mdns-bonjour-discovery
